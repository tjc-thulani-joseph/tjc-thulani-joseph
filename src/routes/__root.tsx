...
import { TJC_IDENTITY, TJC_PERSON_ID } from "@/constants/identity";
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "google-site-verification", content: "BrFKEnazAF67NNLjqZrSGuDn7xu9lgDGamgqxnsrnxc" },
      { title: `${SITE.fullName} — Official Site` },
    ...
    links: [
      ...
      { rel: "stylesheet", href: "https://fonts.googleapis.com/css2?family=Poppins:wght@400;500;600;700&family=Inter:wght@300;400;500;600&family=Space+Grotesk:wght@400;500;700&display=swap" },
    ],
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          alternateName: TJC_IDENTITY.alternateName,
          description: TJC_IDENTITY.description,
          url: TJC_IDENTITY.url,
          image: TJC_IDENTITY.image,
          sameAs: TJC_IDENTITY.sameAs,
        }),
      },
    ],
  }),
...
function RootComponent() {
  ...
  return <QueryClientProvider client={queryClient}><AuthProvider><Outlet /><Toaster /></AuthProvider></QueryClientProvider>;
}
